...
{
	//SMSC_2013_01_31_04_001_2013_01_31_20_12_44_87_1375.TXT
	char pscL_Retry[6]={0x00};
	char pscL_postFix[5]={0x00};
	char Table[6]="SMSC";
	strcpy(pscL_Retry,fnG_getFields(filename,delimiter,5));
	strcpy(pscL_postFix,fnG_getFields(filename,delimiter,4));
...
/*int main(int argc,char** argv)
{
	...
	char tablename[50];
	fnG_getSMSCTable(filename,tablename,'_');
	printf("%s\n",tablename);
}*/
