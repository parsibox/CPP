...
INSERT INTO `DATA_TABLE` VALUES (1,'917676724614',1,1);
...
INSERT INTO `MENU_DETAILS` VALUES (1,1,0,1,'Yes','123',0,0,'TEST','testuser','A','NULL','If you want to subscribe for this Press:',''),(2,2,0,2,'No','123',0,0,'TEST','testuser','A','NULL','',''),(3,3,1,1,'Yes','123',0,0,'TEST','testuser','A','NULL','Please Confirm','http://192.168.220.128:8080/service?MSISDN='),(4,4,1,2,'No','123',0,0,'TEST','testuser','A','NULL','','');
...
INSERT INTO `SCHEDULE_PROFILE` VALUES (1,'TEST',2,1,0,2,'2014-05-03 12:58:08','2014-04-24 15:43:43','',0,'123','123',0,7,1,0,'testuser');
...
INSERT INTO `SCHEDULE_TABLE_MAPPING` VALUES (1,1,'DATA_TABLE','test.csv','C',83);
...
-- Dump completed on 2014-05-06 20:55:09
