...
INSERT INTO `menu_details` VALUES (1,1,1,2,'No','*667#',0,0,'test','icmuser','A','NULL','Do you really want to proced','',0,'Thank you for using our service ,Please dail *1257# for activation',0),(2,0,1,1,'Yes','*667#',0,0,'test','icmuser','A','NULL','Please confirm?','http://10.10.01.15/dummy',1,'Thanks for subscribing you will get the confirmation message',0),(3,0,0,1,'Yes','*667#',0,0,'test','icmuser','A','NULL','Subscribe to the best daily motivatinal tips.','',0,'',1);
...
-- Dump completed on 2016-01-22 20:02:40
