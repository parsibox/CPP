...
protected:
    ...
    mysqlpp::Connection* create()
    {
        ...
        DBG_VERBOSE((CG_EventLog), ("Creating connection object"));
        mysqlpp::Connection *pCL_Conn = new mysqlpp::Connection(false);
//        mysqlpp::Connection *pCL_Conn = new mysqlpp::Connection(
...
//        	DBG_ERROR((CG_EventLog), ("Error in creating connection:%s", e.what()));
//        	pCL_Conn = NULL;
//        }
        return pCL_Conn;
    }
    ...
    void destroy(mysqlpp::Connection* cp)
    {
        ...
        DBG_INFO((CG_EventLog), ("Destroying the db connection"));
        delete cp;
    }
