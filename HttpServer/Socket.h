...
inline
bool Socket::mcfn_closeByDirection(int siL_CloseType)
{
	if(meS_Socket == -1)
		return false;
...
inline
long Socket::mcfn_getLastErrorCode()
{
#ifdef __LINUX__
	return mesl_Error;
...
inline
bool Socket::mcfn_bind(bool bL_ReuseAddr,bool bL_KeppAlive,bool bL_NoDelay)
{
	int option_value = 1;
	if(bL_ReuseAddr)
...
inline
bool Socket::mcfn_recvByte(char *pscL_Buffer)
{
...
inline
bool Socket::mcfn_connect(char *pscL_IP)
{
...
inline
bool Socket::mcfn_send(const char *psl_Buffer,int slL_Len)
{
	int l_returnSend;
...
inline
bool Socket::mcfn_send(const char *psl_Buffer,int slL_Len,int siL_Flag)
{
	int l_returnSend;
