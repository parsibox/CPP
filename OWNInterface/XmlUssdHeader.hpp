...
class CXmlHeader
{
	public:	
		...
		CXmlHeader(int iL_cmdLen,long long iL_SessionId[2],int iL_opType,int iL_sessType){
		...
		CXmlHeader(int iL_cmdLen,long long iL_seqId[2])
		{
			mcsi_cmdLength=iL_cmdLen;
                        mcsi_sessionId[0]=iL_seqId[0];
			mcsi_sessionId[1]=iL_seqId[1];
